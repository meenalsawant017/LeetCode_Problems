...
Given a string S containing only characters a and b. A substring (contiguous fragment) of S is called
a semi-alternating substring if it does not contain three identical consecutive characters.
...
def semi_substring(s):
    ...
    for right in range(len(s)):
        ...
        print('max length:', max_len, 'right - left + 1:', right - left + 1, '\n')
    return max_len
